...
<div class="container-fluid">
    <h4 class="mb-3">Tambah Pengajuan KIA</h4>

    <div class="card p-4 shadow-sm">
        <form action="{{ route('pengajuan-kia.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
                ...
                <select name="jenis_kia" class="form-control" required>
                    ...
                    @foreach($jenisKia as $jenis)
                        <option value="{{ $jenis }}" {{ old('jenis_kia') == $jenis ? 'selected' : '' }}>
                            {{ $jenis }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="mb-3">
                <label for="ktp_ortu" class="form-label">KTP Ortu</label>
            ...
            <div class="mb-3">
                <label for="pass_foto" class="form-label">Foto Anak</label>
