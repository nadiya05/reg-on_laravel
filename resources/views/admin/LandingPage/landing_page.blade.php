                    ...
                    <div style="background:white; padding:20px; border-radius:20px; color:#0077B6; display:inline-block; text-align:left;">
                        <div style="display:flex; align-items:flex-start; gap:12px;">
                            ...
                            <p style="margin:0; font-weight:600; font-size:15px;">
                                Jl.Raya No. 8, Jalan Lohbener – Jatibarang Lama, Lohbener,  
                ...
                <div class="col-md-7">
                    <div style="background:#0077B6; color:white; padding:30px; border-radius:15px; font-size:16px; line-height:1.7; box-shadow:0 6px 15px rgba(0,0,0,0.15);">
                        <p style="font-size:18px; font-weight:600;">
                            Admin Kecamatan memiliki peran penting dalam memastikan informasi dan layanan dapat diakses oleh penduduk secara mudah, cepat, dan akurat. Beberapa tugas utama admin antara lain:
                        </p>

                        <ol style="padding-left:20px; margin-top:20px;">
                            <li style="margin-bottom:15px;"><b>Mengelola Informasi</b><br>Memperbarui data, berita, dan pengumuman agar penduduk mendapat informasi terbaru.</li>
                            <li style="margin-bottom:15px;"><b>Mengatur Layanan Online</b><br>Mengelola antrean KTP, KK, dan KIA.</li>
                            <li style="margin-bottom:15px;"><b>Memeriksa & Memvalidasi Data</b><br>Meninjau data pengajuan penduduk agar lengkap dan sesuai.</li>
                            <li style="margin-bottom:15px;"><b>Menindaklanjuti Pengajuan</b><br>Memantau status layanan dan memberikan notifikasi kepada penduduk.</li>
